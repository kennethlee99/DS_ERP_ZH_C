...
| 看板指标、动作标签、报工页面或工人设置不清楚 | 查看[证据与待决事项登记](00-open-decisions.md)，在指定负责人确认前保持为未结事项。 |

## 演示范围说明

Quality/QC 和 Inspection Planning 保留在手册中，但最终演示范围仍需要演示负责人确认。客户演示仍需确认的证据项记录在[证据与待决事项登记](00-open-decisions.md)中。其他排除或仅支持用途的区域记录在范围说明中，不写入操作指南。
