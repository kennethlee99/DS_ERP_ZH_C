...
|---|---|---|---|---|
| 工单状态动作 | [计划员流程](01-workflows/planner-cold-start.md)、[工单](10-production/production-orders.md) | 只使用清楚可见的动作。不要猜测 release、hold、cancel、reset、close 或 schedule 图标。 | 状态变更前后的工具栏/动作区截图，包含 WO 行和登录角色。 | 计划负责人或负责人 |
