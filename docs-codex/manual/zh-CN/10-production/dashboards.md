...
> |---|---|---|---|
> | 打开看板进行只读趋势观察，并在采取行动前与 WO、计划和队列证据对照。 | 看板指标定义、筛选和批准解释。 | 业务负责人或负责人。 | 每个指标是什么意思、哪些筛选定义复查期间，以及每个看板信号可以如何影响计划、延误、人员、质量或交接决策。 |
...
| 问题 | 含义 |
|---|---|
| 看板页面为空 | 所选筛选期间可能没有数据，或该页面需要负责人确认。 |
| 指标含义不明确 | 只把它当作趋势信号，并在写入确认记录前确认指标定义。 |
